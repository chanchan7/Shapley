...
# 加载预训练的 ResNet-18 模型，去掉最后一层全连接层
...
# 加载 CIFAR-10 数据集
cifar10_data = torchvision.datasets.CIFAR10(root='./data', train=True, transform=transform, download=True)
data_loader = torch.utils.data.DataLoader(dataset=cifar10_data, batch_size=1, shuffle=False)
